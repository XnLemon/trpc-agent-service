...
func TestOrderedFilesAreContiguousAndDigestable(t *testing.T) {
	...
	if len(files) != 8 || files[0].version != 1 || files[1].version != 2 || files[2].version != 3 || files[3].version != 4 || files[4].version != 5 || files[5].version != 6 || files[6].version != 7 || files[7].version != 8 {
