...
GRANT EXECUTE ON FUNCTION public.control_plane_set_agent_app_canary(TEXT,TEXT,BIGINT,BIGINT,BIGINT,BIGINT,TIMESTAMPTZ,TEXT,BIGINT,BIGINT,TEXT,TEXT,TEXT,TEXT,TEXT) TO tenant_app_writer;
