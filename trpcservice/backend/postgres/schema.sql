-- Package-owned base table schema for trpcservice/backend/postgres.
...
CREATE TABLE IF NOT EXISTS public.backend_profile_binding (
...
CREATE TABLE IF NOT EXISTS public.backend_profile_change_outbox (
